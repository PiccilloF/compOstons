...
INSERT INTO
  compost ("category", "longitude", "latitude")
VALUES
  ('Green', -0.5294, 44.8910),
  ('Brown', 1.5068, 45.5988),
  ('Null', 4.5677, 44.0930),
  ('Null', 2.4311, 47.4957),
  ('Brown', 3.3766, 47.1335),
  ('All', 5.9855, 44.2942),
  ('Brown', 0.1913, 45.1239),
  ('Null', 6.6143, 46.8639),
  ('All', 4.5277, 47.9695),
  ('All', -0.7747, 45.9546),
  ('Brown', 1.8147, 45.9359),
  ('Null', -0.4702, 44.3908),
  ('All', 4.4120, 45.9781),
  ('Null', 1.1669, 44.9349),
  ('All', 0.5558, 45.1461),
  ('Brown', 3.0094, 46.1209),
  ('Null', 5.8984, 46.5214),
  ('Null', 1.5486, 45.9193),
  ('All', 3.9988, 44.7545),
  ('Null', -0.1596, 44.9392),
  ('Null', 4.0066, 46.0666),
  ('Brown', 3.2399, 47.6857),
  ('Green', 3.7522, 44.7273),
  ('Null', 6.1003, 47.3980),
  ('Null', 5.5231, 47.5899),
  ('Green', 3.4201, 45.7304),
  ('Brown', -0.4367, 44.2684),
  ('Brown', 1.6396, 45.7806),
  ('All', -0.3535, 46.5351),
  ('Green', 5.7192, 44.2129),
  ('Null', 1.0778, 44.9178),
  ('Green', 4.0871, 44.3365),
  ('Null', 5.6331, 47.1880),
  ('Brown', 1.1270, 45.2839),
  ('Green', 3.4558, 46.5690),
  ('Brown', 1.1823, 47.5221),
  ('Brown', 3.0171, 46.1103),
  ('Brown', 4.5199, 45.1702),
  ('Brown', 2.7659, 44.1301),
  ('Null', 3.8432, 44.9637),
  ('All', 5.8490, 45.7044),
  ('Green', 1.8650, 45.0403),
  ('Null', 3.3633, 44.1407),
  ('All', 2.0515, 44.4815),
  ('Brown', 1.1708, 46.1115),
  ('Brown', 6.7656, 45.5988),
  ('Green', -0.3158, 46.7930),
  ('All', 2.1349, 44.3531),
  ('All', 3.0156, 44.3044),
  ('Brown', -0.8885, 45.6899),
  ('Null', -0.9035, 44.3566),
  ('Brown', 6.5985, 47.1328),
  ('Brown', 4.1091, 47.5994),
  ('Green', 3.3081, 44.3823),
  ('Green', 2.8300, 44.2687),
  ('Brown', 0.5218, 45.1339),
  ('All', 5.5716, 46.8616),
  ('All', 1.7117, 45.3410),
  ('All', -0.7147, 44.6510),
  ('Null', 5.2512, 45.1087),
  ('Green', 0.0910, 44.5476),
  ('Null', 4.4997, 45.1843),
  ('Brown', 3.6535, 46.2534),
  ('Null', 3.2131, 45.9286),
  ('All', 3.1194, 46.6498),
  ('Green', 6.2596, 44.1717),
  ('All', 5.0489, 44.4536),
  ('Null', 4.4670, 46.7557),
  ('All', 6.6928, 44.2506),
  ('Green', 0.5764, 45.7721),
  ('Green', 3.2346, 45.6708),
  ('Brown', 6.1216, 45.7834),
  ('Null', 5.9388, 46.3837),
  ('All', -0.9507, 46.4917),
  ('Brown', 5.4464, 46.2531),
  ('Green', 3.6131, 46.7396),
  ('Green', 3.6909, 44.2664),
  ('Brown', 5.6838, 44.1143),
  ('Null', 4.7855, 43.8884),
  ('Brown', 5.3866, 47.9374),
  ('Brown', -0.0767, 47.9177),
  ('Brown', 0.0014, 47.7379),
  ('All', 4.3034, 43.8570),
  ('All', 1.5485, 47.5842),
  ('Brown', 2.3718, 44.5867),
  ('Green', -0.5843, 44.1782),
  ('Brown', 4.1598, 46.7595),
  ('Null', 4.5264, 45.7015),
  ('Brown', 2.3806, 45.1846),
  ('Green', 5.6174, 44.9869),
  ('Brown', 5.3107, 46.8211),
  ('Null', 4.0190, 47.7077),
  ('All', 2.8484, 47.9330),
  ('All', 5.9484, 44.2731),
  ('All', 0.9543, 44.5901),
  ('Green', 5.9116, 47.9696),
  ('Brown', 6.7464, 46.6165),
  ('Green', 5.3449, 47.3435),
  ('Null', 3.2585, 44.2503),
  ('Brown', 4.8974, 45.3169);
INSERT INTO
  user_compost (
    "firstname",
    "lastname",
